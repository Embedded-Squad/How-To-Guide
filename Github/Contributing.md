...
Fork this repository using the **Fork** option at the top-right corner of this page. This will create your own copy of this repository. You'll be redirected to your forked repository. Copy the link of this repository (which will look like `https://github.com/<your-username>/repo-name/`) as you'll need it in the step 2.
...
Add the Embedded Squad repository as a remote repository, so that you can anytime pull the latest changes from the Embedded Squad repository which is being deployed. This needs to be done only for the first time.

```
git remote add upstream <link-to-original-repository>
```

link to original repository will look like as https://github.com/Embedded-Squad/How-To-Guide.git
...
Perform the tasks you wanted to, can be anything, ranging from fixing simple typo to re-writing whole firmware.
...
Now go to your forked repository and you'll see that **This branch is xx commits ahead of Embedded-Squad-Squad:develop.** Right next to it will be an option to **Pull Request**. Click on it, submit your pull request (also known as _PR_) explaining what you've done.
